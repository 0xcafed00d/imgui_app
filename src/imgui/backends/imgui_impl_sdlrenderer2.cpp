...
// CHANGELOG
//  2024-05-14: *BREAKING CHANGE* ImGui_ImplSDLRenderer3_RenderDrawData() requires SDL_Renderer*
//  passed as parameter. 2023-05-30: Renamed imgui_impl_sdlrenderer.h/.cpp to
//  imgui_impl_sdlrenderer2.h/.cpp to accommodate for upcoming SDL3. 2022-10-11: Using 'nullptr'
//  instead of 'NULL' as per our switch to C++11. 2021-12-21: Update SDL_RenderGeometryRaw() format
//  to work with SDL 2.0.19. 2021-12-03: Added support for large mesh (64K+ vertices), enable
		...
		for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++) {
			...
			if (pcmd->UserCallback) {
				...
				SDL_RenderGeometryRaw(
				    renderer, tex, xy, (int)sizeof(ImDrawVert), color, (int)sizeof(ImDrawVert), uv,
